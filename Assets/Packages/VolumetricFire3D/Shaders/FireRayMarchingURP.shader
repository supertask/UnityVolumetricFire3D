Shader "VolumetricFire3D/URP/FireRayMarching"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //SamplerState samplerCameraOpaque;
            ...
            float lightmarch(StructuredBuffer<float> buffer, Ray rayTowardsLight,
                ...
                //rayTowardsLight.dir = light.dir;

                //rayTowardsLight.dir = _WorldSpaceLightPos0.xyz;
                //rayTowardsLight.dir = _MainLightPosition;
            ...
            float4 frag(v2f IN) : COLOR
            {
                ...
                float cosAngle = dot(ray.dir, _MainLightPosition.xyz);
                ...
                //while (dstTravelled < dstLimit) {
                   ...
                   for(int i=0; i < RAY_STEPS_TO_FLUID; i++, dstTravelled += stepSize) {
                    ...
                    if (density > 0) {
                        ...
                        rayTowardsSunLight.dir = _MainLightPosition;

                        float lightTransmittance = lightmarch(_Density, rayTowardsSunLight, boundingBox, _DensityOffset);
                    ...
                    if (reaction > 0) {
                        ...
                        rayTowardsSunLight.origin = rayPos;
                        rayTowardsSunLight.dir = _MainLightPosition;
                        float lightFireTransmittance = lightmarch(_Reaction, rayTowardsSunLight, boundingBox, _DensityOffset);
                ...
                //float4 sceneColor = _CameraOpaqueTexture.SampleLevel(samplerCameraOpaque, screenUV, 0);
