...
/*
            ...
            */
			...
			float2 rayBoxDst2(float3 boundsMin, float3 boundsMax, float3 rayOrigin, float3 raydir)
			{
			    float3 invR = 1.0 / raydir;
			    float3 tbot = invR * (boundsMin-rayOrigin);
			    float3 ttop = invR * (boundsMax-rayOrigin);
            ...
            float lightmarch(float3 position) {
                ...
                float dstInsideBox = rayBoxDst2(boundsMin, boundsMax, position, dirToLight).y;
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                float2 rayToContainerInfo = rayBoxDst2(boundsMin, boundsMax, rayPos, rayDir);
